# Replace the save_single() function in place
# This is to support custom object properties

import io_scene_fbx
from io_scene_fbx.export_fbx import *
